    ...
    def get_event(link):
       ...
       # title
        ...
        try:
            ...
            start_time_str = input_str.split(" - ")[1].split(" to ")[0]

            start_datetime = parser.parse(date_str + " " + start_time_str)

            # format the date and start time into a single line
            formatted_datetime = start_datetime.strftime("%Y-%m-%d %I:%M%p")
...
def Comparative_Literature(main_url, calendar, dep):
    ...
    def get_event(link):
       ...
       # title
        ...
        try:
            # input string
            input_str = "April 14, 2023 - 11:30am to 2:30pm"
