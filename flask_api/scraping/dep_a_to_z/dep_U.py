...
def neuroscience(main_url, calendar, dep):
    ...
    def get_event(link):
       ...
       # title
        try:
            ...
            # speaker
        try:
            speaker_name = soup.find('span', {'class':'profile-list'}).text.strip()
        except:
            speaker_name = "TBD"
...
department_parsers = {
"https://medicine.yale.edu/urology/": neuroscience

}

def get_all_events_U():
