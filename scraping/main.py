...
from dep_a_to_z.dep_E import Experimental_Pathology,Electrical_Engineering
...
events2 = Experimental_Pathology("https://medicine.yale.edu/pathology", "calendar/", "economics")
