...
def Public_Health(main_url, calendar, dep):
...
def psychology(main_url, calendar, dep):
...
def politicalscience(main_url, calendar, dep):
    """Getting African American studies department's events"""
    # send response to calendar page
...
department_parsers = {
"https://ysph.yale.edu/": Public_Health,
"https://psychology.yale.edu/": psychology,
"https://politicalscience.yale.edu/": politicalscience,
"https://politicalscience.yale.edu/": politicalscience
